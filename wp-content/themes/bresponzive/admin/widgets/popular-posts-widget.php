 ...
 * @since 0.1
 */
 add_action( 'widgets_init', 'tpcrn_popular_posts_widget' );
 /**
 * Register our widget.
 ...
 * @since 0.1
 */
  function tpcrn_popular_posts_widget() {
	register_widget( 'tpcrn_popular_posts_widget' );
}
/**
 ...
 * @since 0.1
 */
class tpcrn_popular_posts_widget extends WP_Widget {
  function tpcrn_popular_posts_widget() {
  $widget_ops = array('classname' => 'tpcrn_popular_posts_widget','description' => __( 'A Widget to dispaly Popular Posts With Thumbs', 'ThemePacific' ));
  $this->WP_Widget('tpcrn-popular-posts-widget', __( 'ThemePacific : Popular Posts Widget', 'ThemePacific' ), $widget_ops);	
	}
...
/**
	...
	function form( $instance ) {
				...
				$defaults = array( 'title' => __('Popular Posts ', 'ThemePacific '),'getnumpost' => '3');
   				$instance = wp_parse_args( (array) $instance, $defaults ); ?>
	
 		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'ThemePacific'); ?></label>
