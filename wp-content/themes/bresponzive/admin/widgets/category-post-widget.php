 ...
 * @since 0.1
 */
 add_action( 'widgets_init', 'tpcrn_recent_category_widget' );
 /**
 * Register our widget.
 ...
 * @since 0.1
 */
  function tpcrn_recent_category_widget() {
	register_widget( 'tpcrn_recent_category_widget' );
}
/**
 ...
 * @since 0.1
 */
class tpcrn_recent_category_widget extends WP_Widget {
  function tpcrn_recent_category_widget() {
  $widget_ops = array('classname' => 'tpcrn_recent_category_widget','description' => __( 'A Widget to dispaly Category Posts With Thumbs', 'ThemePacific' ));
  $this->WP_Widget('tpcrn-cat-posts-widget', __( 'ThemePacific : Category Posts Widget', 'ThemePacific' ), $widget_ops);	
	}
...
/**
	...
	function form( $instance ) {
				...
				$defaults = array( 'title' => __('Category Name ', 'ThemePacific '),'getnumpost' => '3','get_catego' => 'all');
   				$instance = wp_parse_args( (array) $instance, $defaults ); ?>
	
 		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Enter category Name:', 'ThemePacific'); ?></label>
			<input class="widefat" style="width: 216px;" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>" />
		</p>

 		
		<p>
			<label for="<?php echo $this->get_field_id('getnumpost'); ?>"><?php _e('Number of Posts to Show:','ThemePacific'); ?></label>
