 ...
 * @since 0.1
 */
add_action('widgets_init', 'tpcrn_email_news_subscribe_widget');
/**
 * Register our widget.
 ...
 * @since 0.1
 */
function tpcrn_email_news_subscribe_widget()
{
	register_widget('tpcrn_news_subscribe_widget');
}
/**
 ...
 * @since 0.1
 */
class tpcrn_news_subscribe_widget extends WP_Widget {
/**
* Widget setup.
*/
function tpcrn_news_subscribe_widget()
	{
		/* Widget settings. */
		$widget_ops = array('classname' => 'tpcrn_news_subs', 'description' => 'Subscribe to Feedburner Newsletter Widget');
		/* Widget control settings. */
		$control_ops = array('id_base' => 'tpcrn_news_subs-widget');
		/* Create the widget. */
		$this->WP_Widget('tpcrn_news_subs-widget', 'ThemePacific: NewsLetter Subscribe', $widget_ops, $control_ops);
    }
/**
* Display the widget 
*/		
