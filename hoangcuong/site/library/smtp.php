...
class smtp{
    ...
    ****************************************************************************/
    ...
    function SendMail($tomail,$subject,$message)
    {
          ...
          $from = $fromfullname." <".$this->username.">";
          $headers ="Return-Path: ".$this->title." <".$this->username.">\r\n";
          $headers.="From: $from\nX-Mailer: ".$this->title."\r\n";
          $headers .="Mime-Version: 1.0\r\n";
          $headers .="Content-type: text/html; charset=utf-8\r\n";
          $smtp_host = $this->hostname;//Dia chi mail server
          $admin_email = $this->username;//User duoc khai bao tren mail server
          $smtp_username = $this->username;//User duoc khai bao tren mail server
          $smtp_password = $this->password;//Pass cua email nay
          var_dump($this->smtpmail($tomail,$subject,$message,$headers,$smtp_host, $smtp_username, $smtp_password, $admin_email));
